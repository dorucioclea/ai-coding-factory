---
name: rn-grand-architect
description: Meta-orchestrator for complex React Native features. Use for architectural decisions, multi-system integration, and coordinating specialized agents.
