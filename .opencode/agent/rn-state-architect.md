---
name: rn-state-architect
description: State management design specialist for Redux Toolkit, TanStack Query, and persistence patterns. Use when designing state architecture or implementing complex state flows.
