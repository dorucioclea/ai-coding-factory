...
description: Test generation specialist for React Native. Use for creating Jest unit tests, React Native Testing Library component tests, Detox/Maestro E2E tests.
