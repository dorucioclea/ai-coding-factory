...
- Implementing plans from planning skills
...
2. ~/.config/acf/worktrees/<project>/ (global location)
...
# Or global
path="$HOME/.config/acf/worktrees/$project/$BRANCH_NAME"
...
# Or global
$path = "$env:USERPROFILE\.config\acf\worktrees\$project\$BRANCH_NAME"
...
- **planning** - Plan to execute in worktree
- **verification-loop** - Verify before finishing branch
