<!-- Use when creating .NET backend projects, implementing domain entities, CQRS handlers, or working with Clean Architecture patterns. References the clean-architecture-solution template. -->
