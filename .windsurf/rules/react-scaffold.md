<!-- Use when creating React/Next.js frontend projects, adding React components, or implementing frontend features. References the react-frontend-template and best practices. -->
