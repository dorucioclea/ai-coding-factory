...
export async function statusCommand(projectRoot) {
    ...
    try {
        ...
        console.log(table([["ID", "Name", "Status", "Artifacts"], ...systemData], {
            columns: [
                { width: 12 },
                { width: 18 },
        ...
        if (history.length > 0) {
            ...
            console.log(table([["Job ID", "Source", "Targets", "Status", "Started"], ...historyData], {
                columns: [
                    { width: 14 },
                    { width: 10 },
                    { width: 20 },
