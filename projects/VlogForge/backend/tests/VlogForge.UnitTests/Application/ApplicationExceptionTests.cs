...
using Xunit;
using ApplicationUnauthorizedAccessException = VlogForge.Application.Common.Exceptions.UnauthorizedAccessException;
using ValidationException = VlogForge.Application.Common.Exceptions.ValidationException;
using ForbiddenAccessException = VlogForge.Application.Common.Exceptions.ForbiddenAccessException;
using NotFoundException = VlogForge.Application.Common.Exceptions.NotFoundException;
